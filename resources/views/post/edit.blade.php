...
<form action="{{route('post.update', $id)}}" method="POST">
    ...
    <div class="mb-3">
        ...
        <input value="{{$id->title}}" name="title" type="text" class="form-control" id="title" placeholder="Название поста: ">
        @error('title')
    ...
    <div class="mb-3">
        ...
        <textarea name="content" class="form-control" id="content" cols="5" rows="5" placeholder="Содержание: ">{{$id->content}}</textarea>
        @error('content')
        <p class="text-danger">Обязательное поле</p>
        @enderror
    </div>
    <div class="mb-3">
        ...
        <input value="{{$id->images}}" name="images" type="text" class="form-control" id="images" placeholder="Картинка: ">
        @error('images')
        <p class="text-danger">Обязательное поле</p>
        @enderror
    </div>
    <div class="input-group mb-3">
        ...
        <select class="form-select" id="status" name="status">
            <option value="0">Скрыт (по умолочанию)</option>
    ...
    <div class="input-group mb-3">
        ...
        <select class="form-select" id="categ" name="category_id">
            ...
            <option {{$categ->id === $id->category_id ? "selected" : ""}}
